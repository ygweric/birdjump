...
- (id) init
{
	...
	if (self)
	{
        ...
        CCLabelBMFont *shopLabel = [CCLabelBMFont labelWithString:@"SHOP" fntFile:@"futura-48.fnt"];
        //        helpLabel.scale=HD2SD_SCALE;
        CCMenuItemLabel* shopping =[CCMenuItemLabel itemWithLabel:shopLabel target:self  selector:@selector(onShop:)];
		...
		CCMenu *mn = [CCMenu menuWithItems:newGame, gameSttings, helpGame,shopping, nil];
        //mn.position==160,240
