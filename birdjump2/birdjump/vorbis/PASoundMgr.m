...
- (void)initListener {
    ...
    listener.position=CGPointMake(0, 0);
}
...
- (PASoundSource *)addSound:(NSString *)name withExtension:(NSString *)ext  looped:(BOOL)yn {
    return [self addSound:name withExtension:ext position:CGPointMake(0, 0) looped:YES];
}
